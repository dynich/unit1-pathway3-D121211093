...
fun MiddlePart() {
    ...
    Column(
        ...
        Text(text = "Hidayatullah Akbar", fontSize = 30.sp, modifier = Modifier.padding(top = 16.dp))
        Text(text = "Android Developer Enthusiast", fontSize = 16.sp, fontWeight = FontWeight.SemiBold, color = Color(0xFF006833), modifier = Modifier.padding(top = 8.dp))
    }
}
    ...
    Tugas1Theme {
        ...
        MiddlePart()
            Column(
                ...
                DataRow(text = "+62 821 5751 9441", icon = Icons.Default.Call)
                DataRow(text = "@dynich", icon = Icons.Default.Share)
                DataRow(text = "dayatakbar06@gmail.com", icon = Icons.Default.Email)
            }
        }
    }
}